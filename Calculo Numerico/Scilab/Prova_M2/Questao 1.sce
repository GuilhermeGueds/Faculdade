...
//-----------------------------------------------------------------------------
x = [0.35,0.40,0.45,0.50,0.55,0.60,0.65]       //x
y = [1.52,1.51,1.49,1.47,1.44,1.42,1.39]    //f(x)
A = 0.62                              //ponto para achar
p = poly(0,'x')
//------------------------------------------------------------------------------
...
disp('')
//-----------------------------------------------------------------------------
erro = EstimarErro(x,A,200)           //calcula Erro
disp('Erro:')
