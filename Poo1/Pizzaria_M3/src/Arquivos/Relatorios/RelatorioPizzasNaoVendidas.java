...
/**
 * Classe Relatório de Pizzas Não Vendidas.
 * 
 * @author Guilherme Guedes e Daniel Passos
 */
public class RelatorioPizzasNaoVendidas extends Relatorios{
    ...
    public String toString() {
        ...
        output.append("                       Relatorio Pizzas Não Vendidas" + AppConfig.NEW_LINE);
